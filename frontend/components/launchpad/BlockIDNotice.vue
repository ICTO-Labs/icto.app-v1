...
<template>
    <div class="notice bg-light-primary p-2 pb-0 rounded mt-2">
        <div class="fs-12"> 
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex flex-column align-items-center">
                    <h4 class="text-primary mt-1"><i class="fas fa-shield-alt text-primary fs-2"></i> BlockID verification</h4>
                </div>
                <div class="d-flex flex-column align-items-center">
                    <a href="javascript:void(0)" @click="checkEligible" class="btn btn-sm btn-primary" :disabled="isLoading">
                        <span v-if="isLoading"><i class="fas fa-spinner fa-spin"></i> Refreshing...</span>
                        <span v-else><i class="fas fa-sync-alt"></i> Refresh</span>
                    </a>
                </div>
            </div>
            <div>
                <table class="table table-border mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center w-50"><span class="font-bold text-success fs-1 border border-dashed border-primary rounded px-5 py-2 bg-white">{{blockId || 10}}</span></td>
                        ...
                        <tr>
                            <td colspan="2" class="text-center fw-bold fs-5">
                                ...
                                <div class="align-items-center" v-else>
                                    <span class="text-success" v-if="eligibleToCommit && 'ok' in eligibleToCommit && walletStore.isLogged">
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <div>
                                    To participate, you must first login and verify your wallet at 
                                    <a href="https://blockid.cc" class="text-blue-600 hover:underline" target="_blank" rel="noopener">blockid.cc <i class="fas fa-external-link-alt"></i></a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
