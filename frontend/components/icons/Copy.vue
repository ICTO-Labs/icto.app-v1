...
<template>
    <button href="javascript:void(0)" @click.stop="copyToClipboard()" title="Copy" class="btn btn-active-color-primary btn-icon btn-sm btn-outline-light">
        <span :class="`svg-icon svg-icon-2 ${isCopied?'d-none':''}`">
        ...
        <i v-if="isCopied" class="bi bi-check fs-2x"></i>
    </button>
</template>
<style>
    .copy{
