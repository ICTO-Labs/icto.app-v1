...
<template>
    ...
    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid first" id="kt_create_account_stepper" data-kt-stepper="true">
            ...
            <div class="d-flex flex-row-fluid flex-center bg-body rounded">
                <!--begin::Form-->
                <form class="py-20 w-100 w-xl-900px px-9 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_create_account_form">
                    <!--begin::Step 1-->
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <!--begin::Option-->
                                        <input type="radio" class="btn-check" name="account_type" value="corporate" id="dao-model" disabled>
                    ...
                    <div class="separator separator-dashed mb-10"></div>
                        ...
                        <div class="row mb-10">
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-bold form-label mb-2">Curency</label>
                                <div class="row fv-row">
                                    <div class="col-12">
                                        <select name="listing" class="form-select" v-model="launchpad.currency">
                                            ...
                                            <option value="ghost" disabled>GHOST</option>
                                        </select>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row" v-if="launchpad.affiliate">
                                ...
                                <input type="number" min="10" max="100" class="form-control" v-model="launchpad.affiliateAmount" placeholder="Percent" required />
                            </div>
                        </div>
                    ...
                    <div class="row mb-10">
								...
								<div class="row fv-row">
									<div class="col-12">
										<select name="listing" class="form-select" v-model="launchpad.listing" @change="changeListing">
											...
											<option value="ICPSwap" selected>ICPSwap</option>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" min="10" max="100" class="form-control" v-model="launchpad.listingLiquidity" placeholder="Percent" :disabled="launchpad.listing == 'manually'" />
