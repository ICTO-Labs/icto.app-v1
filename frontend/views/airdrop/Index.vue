<script setup>
	...
	import NewAirdropModal from './NewAirdropModal.vue';
...
<template>
	<Toolbar :current="`Total Airdrop`" :showBtn="{modal: 'showNewAirdropModal', icon: 'fa-rocket', css: 'btn-success', label: 'New Airdrop'}"/>

	<div class="card card-xl-stretch mb-5 mb-xl-10">
	<div class="card-header border-0 pt-5">
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bolder fs-3 mb-1">Airdrop <span class="badge badge-light-primary">{{ myToken?myToken.length:0 }}</span></span>
