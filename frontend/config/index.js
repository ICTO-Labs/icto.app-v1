...
const NETWORK = {
    "dev": {
        ...
        launchpad_id: local_canisters?.launchpad?.local,//Mapping launchpad canister
    ...
    "ic": {
        ...
        launchpad_id: canisters?.launchpad?.ic,//Mapping canister
        host: "https://icp-api.io",
        scan: "https://dashboard.internetcomputer.org/canister/",
