export default ({ IDL }) => {
    ...
    const EXTNFT = IDL.Service({
        ...
        'getCollectionInfo' : IDL.Func([], [CollectionInfo], ['query']),
        ...
        'removeAsset' : IDL.Func([AssetHandle], [Result_6], []),
        'reserve' : IDL.Func(
        ...
        'updateCollectionInfo' : IDL.Func([CollectionInfo], [CollectionInfo], []),
    });
    return EXTNFT;
};
export const init = ({ IDL }) => {
    const AccountIdentifier = IDL.Text;
    return [IDL.Principal, IDL.Text, AccountIdentifier, IDL.Nat64];
};